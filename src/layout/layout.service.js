...
var store = {
    smartSkin: localStorage.getItem('sm-skin') || dinazor_config_1.config.smartSkin,
    skin: dinazor_config_1.config.skins.find(function (_skin) {
        return _skin.name == (localStorage.getItem('sm-skin') || dinazor_config_1.config.smartSkin);
    }),
    skins: dinazor_config_1.config.skins,
